...
export default async function ServiciosPage() {
  ...
  return (
    ...
    >
      {/* Contador de servicios - Barra informativa */}
      {services.length > 0 && (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 text-sm">
                    <span className="font-bold text-2xl text-neutral-900">{services.length}</span> servicios disponibles para ti
                  </p>
                </div>
              </div>
      ...
      {/* CTA Section - Diseño moderno */}
      <div className="mt-16">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand to-brand-700 p-1">
          <div className="bg-white rounded-[22px] p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-neutral-600 text-lg mb-8 leading-relaxed">
                Nuestros asesores están listos para ayudarte a encontrar la solución perfecta para tus necesidades financieras.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  href="/contacto"
                  className="inline-flex items-center justify-center px-8 py-4 bg-brand text-white font-semibold rounded-xl hover:bg-brand-600 transition-all shadow-lg hover:shadow-xl hover:scale-105"
                >
                  Hablar con un asesor
                </a>
                <a
                  href="/nosotros"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white border-2 border-neutral-200 text-neutral-700 font-semibold rounded-xl hover:border-brand-300 hover:bg-brand-50 transition-all"
                >
